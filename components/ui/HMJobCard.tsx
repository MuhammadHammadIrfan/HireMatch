    ...
    <HMCard onClick={onPress}>
      <div className="flex items-start gap-3 mb-3">
        ...
        <div className="flex-1 min-w-0">
          <div className="font-display text-[15px] font-bold text-hm-textP mb-0.5 truncate">{job.title}</div>
          <div className="text-[13px] text-hm-textS">{job.recruiter?.company_name}</div>
        </div>
